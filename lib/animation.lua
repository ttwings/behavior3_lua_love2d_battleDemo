...
--- @class animation
--- @param img Image 保存动画的image对象 fx,fy,lx,ly 动画第一像素和最后一个像素位置不包含外框
--- @param fx number 动画图片间距
--- @param fy number 动画图片间距
--- @param w number
--- @param h number
--- @param offx number
--- @param offy number
--- @param lx number
--- @param ly number
--- @param delay number 动画延时
--- @param count number 帧数,如缺省则取最大
